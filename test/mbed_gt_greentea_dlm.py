...
class GreenteaDlmFunctionality(unittest.TestCase):
    def setUp(self):
        ...
        self.home_tools_patch = patch('mbed_tools.test.mbed_greentea_dlm.HOME_DIR', temp_dir)
        ...
        self.kettle_tools_patch = patch('mbed_tools.test.mbed_greentea_dlm.GREENTEA_KETTLE_PATH', kettle_dir)
